using DataFrames
using ..PrevisibilityCrawler.Utils: value1d
using ..PrevisibilityCrawler.Learning: Pipeline, crossvalidation!
using ..PrevisibilityCrawler.Evolutionary: Gene
using ..PrevisibilityCrawler.Pso: RandomIntervals, Particle, activate
